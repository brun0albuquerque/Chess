...
public enum Colors {
    ...
    public static final Color GREEN = new Color(49, 150, 18);
    public static final Color LIGHT_GREEN = new Color(213, 255, 197);

    public static final Color BLUE = new Color(35, 85, 250);
